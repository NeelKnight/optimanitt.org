(function(){
	...
	// Edited and improvised by NeelKnight
	
	$.fn.tzShutter = function(options){
		
		// Checking for canvas support.Should work in all modern browsers:
		...
		window.setTimeout(function(){
			...
			var frames = {num:12, height:500, width:800},
				slices = {num:12, width: 416, height:500, startDeg:30},
				animation = {
					width : element.width(),
